...
def appliquer_deplacement(grille,joueur,pion_depart,case_arrivée):
    ...
    #print(nombre_capture(grille, case_arrivée,joueur))
    ...
    for direction_x,direction_y in directions :
        ...
        if est_dans_grille(case_a_capturer) and est_pion_adverse(grille,num_joueur,x,y):
            if (y==9 and grille[x][y-2] == '_') or (y==0 and grille[x][y+2] =='_'):
                grille[x][y] = "_"
            elif (not est_dans_grille(chr(65+x)+str(y+2)) or grille[x][y+1] == joueur_pion ) and (not est_dans_grille(chr(65+x)+str(y-1)) or grille[x][y-1] == joueur_pion ) :
                grille[x][y] = "_" # capture
                
            if (x==9 and grille[x-2][y] == '_') or (x==0 and grille[x+2][y] =='_'):
                grille[x][y] = "_"
            elif (not est_dans_grille(chr(x+66)+str(y+1)) or grille[x+1][y] == joueur_pion ) and (not est_dans_grille(chr(x+64)+str(y+1)) or grille[x-1][y] == joueur_pion) :
                grille[x][y] = "_" # capture

def nombre_capture(grille, case_arrivée, num_joueur):
    #j'ai opte pour cette fonction qui comptre le nomre de capture faite par le joueur suite a son deplacement dans la case case arrivee
    directions = [(0, 1), (1, 0), (0, -1), (-1, 0)]  # Nord, Est, Sud, Ouest
    nb_captures=0
    joueur_pion = "x" if num_joueur == 1 else "o"
    adversaire_pion = "o" if num_joueur == 1 else "x"
...
def liste_deplacements(grille,joueur):
    liste_deplacements=[]     # liste pour stocker les mouvements possibles
    for ligne in range(10):
        for colonne in range(10):
            ...
            if est_pion_joueur( grille,joueur, ligne,colonne):
                for L, C in [(-1, 0), (1, 0), (0, -1), (0, 1)]:  # parcours des directions orthogonales possibles
                    ...
                    if est_dans_grille(indice_vers_coordonnees(ligne_cible, colonne_cible)) and case_vide(grille, indice_vers_coordonnees(ligne_cible, colonne_cible)):
                        ...
                        grille[ligne_cible][colonne_cible]='x' if joueur==1 else 'o'
                        liste_deplacements.append((case_depart,case_arrivee,nombre_capture(grille, case_arrivee,joueur)))# ajout du mouvement à la liste des mouvements possibles
                        grille[ligne_cible][colonne_cible]='_'
...
def choisir_nb_capture_max(grille,liste,joueur):
#Cette fonction permet de choisir le triplet de la liste_deplacement qui a le nombre de capture maximal si on applique le deplacement 
    cd,ca,nb_max=liste[0]
    for case_dep,case_arr,nb_cap in liste:
        if nb_max<=nb_cap:
            nb_max=nb_cap
            cd,ca,nb_max=case_dep,case_arr,nb_cap
    return cd,ca,nb_max
    
    
def tour_de_IA(grille,ia):
    liste_deplacement=liste_deplacements(grille,ia)
    #print(liste_deplacement)
    mouvement_choisi = choisir_nb_capture_max(grille,liste_deplacement,ia)
    coordonnees_depart,coordonnees_arrivees,nb_capture=mouvement_choisi
    Test=deplacement_orthogonal(grille,coordonnees_depart,coordonnees_arrivees)
    grille=appliquer_deplacement(grille,ia,coordonnees_depart,coordonnees_arrivees)
...
def test_liste_deplacements():
    assert liste_deplacements(grille1,1) ==[('D1', 'C1', 0), ('D1', 'E1', 0), ('D2', 'C2', 0), ('D2', 'E2', 0), ('D3', 'C3', 0), ('D3', 'E3', 0), ('D4', 'C4', 0), ('D4', 'E4', 0), ('D5', 'C5', 0), ('D5', 'E5', 0), ('D6', 'C6', 0), ('D6', 'E6', 0), ('D7', 'C7', 0), ('D7', 'E7', 0), ('D8', 'C8', 0), ('D8', 'E8', 0), ('D9', 'C9', 0), ('D9', 'E9', 0), ('D10', 'C10', 0), ('D10', 'E10', 0), ('I1', 'H1', 0), ('I1', 'J1', 0), ('I2', 'H2', 0), ('I2', 'J2', 0), ('I3', 'H3', 0), ('I3', 'J3', 0), ('I4', 'H4', 0), ('I4', 'J4', 0), ('I5', 'H5', 0), ('I5', 'J5', 0), ('I6', 'H6', 0), ('I6', 'J6', 0), ('I7', 'H7', 0), ('I7', 'J7', 0), ('I8', 'H8', 0), ('I8', 'J8', 0), ('I9', 'H9', 0), ('I9', 'J9', 0), ('I10', 'H10', 0), ('I10', 'J10', 0)]
    assert liste_deplacements(grille1,2) ==[('B1', 'A1', 0), ('B1', 'C1', 0), ('B2', 'A2', 0), ('B2', 'C2', 0), ('B3', 'A3', 0), ('B3', 'C3', 0), ('B4', 'A4', 0), ('B4', 'C4', 0), ('B5', 'A5', 0), ('B5', 'C5', 0), ('B6', 'A6', 0), ('B6', 'C6', 0), ('B7', 'A7', 0), ('B7', 'C7', 0), ('B8', 'A8', 0), ('B8', 'C8', 0), ('B9', 'A9', 0), ('B9', 'C9', 0), ('B10', 'A10', 0), ('B10', 'C10', 0), ('G1', 'F1', 0), ('G1', 'H1', 0), ('G2', 'F2', 0), ('G2', 'H2', 0), ('G3', 'F3', 0), ('G3', 'H3', 0), ('G4', 'F4', 0), ('G4', 'H4', 0), ('G5', 'F5', 0), ('G5', 'H5', 0), ('G6', 'F6', 0), ('G6', 'H6', 0), ('G7', 'F7', 0), ('G7', 'H7', 0), ('G8', 'F8', 0), ('G8', 'H8', 0), ('G9', 'F9', 0), ('G9', 'H9', 0), ('G10', 'F10', 0), ('G10', 'H10', 0)]
    assert liste_deplacements(grille3,1) ==[('G10', 'F10', 0), ('G10', 'H10', 0), ('G10', 'G9', 0), ('J9', 'I9', 0), ('J9', 'J10', 0)]
    assert liste_deplacements(grille3,2) ==[('D7', 'C7', 0), ('D7', 'E7', 0), ('D7', 'D6', 0), ('D7', 'D8', 0), ('I8', 'H8', 0), ('I8', 'I7', 0), ('I8', 'I9', 2), ('J8', 'J7', 0)]
    print("ok, liste_deplacements validé ")
